...
class FileOperations:
    ...
    def batch_rename(
        self, directory: str, pattern: str, replacement: str
    ) -> list[tuple[str, str]]:
        """Batch rename files.
    ...
    def copy_files(
        self, source: str, destination: str, pattern: str = "*"
    ) -> list[str]:
    ...
    def create_directory_structure(self, base: str, structure: dict[str, Any]) -> None:
